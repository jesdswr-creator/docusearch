...
constexpr const char* kAppVersion     = "1.6.4";  // v1.6.4: translucent (truly rounded) tooltips, live indexed count, distinct-path duplicate groups, hardware-scaled AI inference, tag input + settings spacing fixes
