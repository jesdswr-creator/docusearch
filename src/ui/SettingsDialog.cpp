...
SettingsDialog::SettingsDialog(const AppSettings& current,
    ...
    auto* ocrInfo = new QLabel(
        "OCR is powered by RapidOCR (PaddleOCR ONNX models),\n"
        "running in a separate helper process.\n\n"
        "No Python required. No external downloads needed.\n"
        "The OCR helper (docusearch_ocr_helper.exe) runs as a\n"
        "separate process — if it crashes, the main app is\n"
        "completely unaffected.\n\n"
        "Models are in the 'models' folder next to the exe:\n"
